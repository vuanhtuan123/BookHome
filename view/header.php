	...
	<div id="header" class="shell">
		...
		<div id="navigation">
			<ul>
				...
				<li><a href="index.php?act=gioithieu">Products</a></li>
				<li><a href="index.php?act=lienhe">Promotions</a></li>
				<li><a href="index.php?act=gioithieu">Profile</a></li>
				<li><a href="index.php?act=gopy">About Us</a></li>
				<li><a href="index.php?act=hoidap">Contacts</a></li>
			</ul>
		</div>
		<!-- End Navigation -->
		<div class="cl">&nbsp;</div>
