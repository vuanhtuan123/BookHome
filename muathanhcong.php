		...
		<div class="container">
			...
			<?php
				...
				foreach($hoadon as $hd){
					$tongtien += $hd['price']*$hd['SLSanPham'];
					echo '<h3>Tên hàng: '.$hd['name'].' - số lượng: '.$hd['SLSanPham'].' - tổng tiền: '.$hd['price']*$hd['SLSanPham'].'</h3>';
					
				}
				echo '<br><h2>Tổng tiền đã thanh toán: '.$tongtien.'</h2>';
			?>
		</div>
