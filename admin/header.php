        ...
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse mt-8" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="?act=order-items" data-toggle="tooltip" data-placement="bottom" title="BÁO CÁO">Lịch sử đặt hàng</a>
                    <li><a href="?act=statistical" data-toggle="tooltip" data-placement="bottom" title="BÁO CÁO">Thống kê</a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="dropdown">
                            <li><a href="../logout.php" data-toggle="tooltip" data-placement="bottom"
