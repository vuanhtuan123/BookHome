        ...
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse mt-8" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="index.php" data-toggle="tooltip" data-placement="bottom" title="ĐIỂM DANH">Trang chủ</a></li>
                    <li><a href="index.php?act=adddm" data-toggle="tooltip" data-placement="bottom" title="TIỀN LƯƠNG">Danh mục</a></li>
                    <li><a href="index.php?act=addsp" data-toggle="tooltip" data-placement="bottom" title="LỊCH CÔNG TÁC">SẢN PHẨM</a>
                    </li>
                    <li><a href="#contact" data-toggle="tooltip" data-placement="bottom" title="BÁO CÁO">Thống kê</a>
                    </li>
                    <li><a href="#tour" data-toggle="tooltip" data-placement="bottom" title="SỰ KIỆN">Bình luận</a></li>
                    <li>
