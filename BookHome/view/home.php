    ...
    <div class="container">
        ...
        <div class="row bestselling__banner">
            ...
            <div class="bestselling__banner-left col-lg-6">
                <img src="view/images1/banner/920x420_phienchodocu.png" alt="Banner quảng cáo" class="bestselling__banner-left-img">
            </div>
            <div class="bestselling__banner-right col-lg-6">
                <img src="view/images1/banner/muonkiepnhansinh_resize_920x420.jpg" alt="Banner quảng cáo" class="bestselling__banner-right-img">
            </div>
        </div>
    </div>
</section>
                        ...
                        echo '<div class="product__panel-item col-lg-3 col-md-4 col-sm-6 ' . $mr . '">
                                <div class="product__panel-item-wrap">
                                    ...
                                    <h3 class="product__panel-heading">
                                        <a href="#" class="product__panel-link">' . $name . '</a>
                                    </h3>
...
<section class="product__love">
    <div class="container">
        ...
        <div class="row bg-white">
            ...
            <div class="product__panel-item col-lg-2 col-md-3 col-sm-6">
                <div class="product__panel-img-wrap">
                    <img src="\BookHome\view\images1\product\bia1_tobinhyen_2_1_1.jpg" alt="" class="product__panel-img">
                </div>
                <h3 class="product__panel-heading">
